...
def get_repo_details():
    ...
    branches = {}
    for line in (
        subprocess.check_output(["git", "show-ref"]).decode("utf-8").splitlines()
    ):
    ...
    head = (
        subprocess.check_output(["git", "symbolic-ref", "HEAD"])
        .decode("utf-8")
        .replace("refs/heads/", "")
        .strip()
    )
...
if __name__ == "__main__":
    ...
    print(json.dumps(get_repo_details()))
